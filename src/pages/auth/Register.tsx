...
export const Register = () => {
  ...
  return (
    <>
      <SEO
        title="Sign Up - StreamCinema"
        description="Create your StreamCinema account to start streaming your favorite movies and TV shows."
      />
        ...
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-400">
              Join StreamCinema to start watching your favorite content.
            </p>
          </div>
