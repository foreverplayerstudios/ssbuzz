...
export const Login = () => {
  ...
  return (
    <>
      <SEO
        title="Sign In - StreamCinema"
        description="Sign in to your StreamCinema account to access your watchlist and continue streaming your favorite movies and TV shows."
      />
