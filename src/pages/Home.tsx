...
export const Home = () => {
  ...
  const seoDescription = trendingMovies?.length 
    ? `Stream the latest movies and TV shows in HD quality on StreamCinema. Now trending: ${trendingMovies.slice(0, 3).map(m => m.title).join(', ')}. Watch your favorite content anytime, anywhere.`
    : "Stream the latest movies and TV shows in HD quality on StreamCinema. Watch your favorite content anytime, anywhere. Free streaming of popular movies and TV series.";
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#0f0f0f]">
        <h1 className="sr-only">StreamCinema - Watch Movies & TV Shows Online</h1>
