...
export const SEO: React.FC<SEOProps> = ({
  ...
  const organizationSchema = {
    ...
    sameAs: [
      'https://facebook.com/streamcinema',
      'https://twitter.com/streamcinema',
      'https://instagram.com/streamcinema',
    ],
    contactPoint: {
      '@type': 'ContactPoint',
      contactType: 'customer support',
      email: 'contact@streamcinema.buzz'
    }
  };
  ...
  return (
    <Helmet>
      ...
      <meta name="twitter:site" content="@streamcinema" />
      <meta name="twitter:creator" content="@streamcinema" />
      ...
      {publishedAt && <meta property="article:author" content="StreamCinema" />}
